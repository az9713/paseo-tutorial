> # 📚 Enhanced clone — Paseo, with deep-dive documentation
>
> **This repository is a clone of the original [Paseo](https://github.com/getpaseo/paseo) project, enhanced with a beginner-friendly deep-dive documentation set** that demystifies how Paseo actually works under the hood.
>
...
> | --- | ------------------- |
> | [index](docs/understanding-paseo/index.md) | Navigation hub — start here |
> | [what-is-paseo](docs/understanding-paseo/what-is-paseo.md) | The mental model: one worker, many remote controls |
> | [quickstart](docs/understanding-paseo/quickstart.md) | Install → pair your phone → first agent in ~10 min |
> | [key-concepts](docs/understanding-paseo/key-concepts.md) | Every term defined in plain English |
> | [how-pairing-works](docs/understanding-paseo/how-pairing-works.md) | The QR code and encryption, step by step |
> | [how-paseo-finds-your-sessions](docs/understanding-paseo/how-paseo-finds-your-sessions.md) | Session discovery, the live-mirroring trap, ending sessions |
> | [security](docs/understanding-paseo/security.md) | What's protected, what's on you, the honest limits |
>
> _All original code and credit belong to the upstream project — [getpaseo/paseo](https://github.com/getpaseo/paseo) by Mohamed Boudra, licensed AGPL-3.0. This fork adds documentation only and makes no code changes._
